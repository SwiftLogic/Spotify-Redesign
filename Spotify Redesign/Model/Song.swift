...
var likedSongs = [
    ...
    Song(album_name: "7/27 Harmony", album_author: "KCamila Cabello", album_cover: "p11"),
    Song(album_name: "Joanna", album_author: "Lady Gaga", album_cover: "p12"),
    Song(album_name: "Roar", album_author: "Katy Perry", album_cover: "p13"),
...
var generes = ["Classic", "Hip-Hop", "Electronic", "Chillout", "Dark", "Calm", "Ambient", "Dance"]
